<%-- 
    Document   : index
    Created on : 08/10/2013, 09:10:15 AM
    Author     : LapJgarciavi
--%>
...
<html>
    <head>
        ...
        <title>Consulta de Tributos - SUNAT</title>
...
-->
    ...
    <body bgcolor="#AAAAAA" onLoad="JavaScript:format(0)" style="">
...
<form target="mainFrame" method="post" name="mainForm" action="encontrar">
     ...
     <tr>
      <td>
       <table cellspacing="2" cellpadding="3" width="100%" border="0">
        <tbody>
         <tr>
          <td height="181" align="left" bgcolor="#3399cc"><p><img src="imagen/Sunat-Logo.gif" width="312" height="76"><img src="imagen/cobrar.jpg" width="654" height="74"></p>
            <p><b>CRITERIOS DE BÚSQUEDA:</b></p></td>
         </tr>
        </tbody>
       </table>
   ...
   <table width="969" border="0">
     <tr>
       <td width="411">Nota: Debido a mantenimiento solo esta disponible la opcion RUP </td>
   ...
   %>
   <p class="gamma-pos-alert Estilo12">EMPRESA /PERSONA DEUDORA: <%= snombre %> </p>
  <%   for(Object mdebe : wdeudas){
      String[] zdato = (String[])mdebe;
  %>
   <table width="453" border="0" align="center">
     <tr>
       <th width="173" class="T3" scope="row"><div align="left">Tributo:</div></th>
       <td width="270" class="bgn-required"><%= zdato[1] %></td>
     </tr>
     <tr>
       <th class="T3" scope="row"><div align="left">RUC:</div></th>
       <td class="bgn-required"><%= zdato[0] %></td>
     </tr>
     <tr>
       <th class="T3" scope="row"><div align="left">Periodo Tributario: </div></th>
       <td class="bgn-required"><%= zdato[2] %></td>
     </tr>
     <tr>
       <th class="T3" scope="row"><div align="left">Resolucion:</div></th>
       <td class="bgn-required"><%= zdato[3] %></td>
     </tr>
     <tr>
       <th class="T3" scope="row"><div align="left">Codigo Tributo: </div></th>
       <td class="bgn-required"><%= zdato[4] %></td>
     </tr>
     <tr>
       <th class="T3" scope="row"><div align="left">Importe a pagar: </div></th>
